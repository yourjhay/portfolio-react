          ...
          <div className="terminal-inner-container">
            <div className="terminal-title-bar">
              ...
              <div className="terminal-title-text">
                RJ: <span className="blue">About</span>
              </div>
            </div>
            ...
            <div className="terminal-content-container">
              <div className="terminal-content-text">
                ...
                <p className="blue flex items-center">
                  {" "}
                  {chevronRight} React.js
                </p>
                ...
                <p className="pt-5">
                  And oh! I don't use Microsoft Windows. 🙃
                </p>
              </div>
            </div>
